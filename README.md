...
what you wanna watch.One more thing, the text file of `all_tagged.txt` stores all of the thread with one of the tags mentioned in the usage above and the `all.txt` stores all of the threads in the forum which you specify.
